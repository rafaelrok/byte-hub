...
Simply point your [API requests](https://github.com/gothinkster/bytehub/tree/master/api) to `http://localhost:8080/api` and you're good to go!
...
```html
<link rel="stylesheet" href="//demo.bytehub.io/main.css" />
```
  ...
  <div class="container page">
    <div class="row article-content">
      <div class="col-md-12">
        ...
        <h2 id="introducing-ionic">Introducing bytehub.</h2>

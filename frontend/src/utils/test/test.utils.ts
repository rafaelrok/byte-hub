...
export function renderOptions(): RenderOptions<any>
export function renderOptions(
  args: Partial<Omit<RenderOptionsArgs, 'initialRoute'>>,
): RenderOptions<any>
export async function renderOptions(
  args: Partial<RenderOptionsArgs> & { initialRoute: RouteLocationRaw },
): Promise<RenderOptions<any>>
export function renderOptions(
  args: Partial<RenderOptionsArgs> = {},
): RenderOptions<any> | Promise<RenderOptions<any>> {
